...
** A WC/LS job to add noise-free ADC

Perhaps running WCT sim and saving sparse waveforms will actually be
faster and smaller.
...
That looks like a bug in my config.  I need to set an explicit tag
name.  I think there should also be a "channels" array?
